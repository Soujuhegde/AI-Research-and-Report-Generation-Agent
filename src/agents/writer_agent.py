    ...
    messages = [
        ...
        HumanMessage(
            content=f"Topic: {state.topic}\n\n"
                    ...
                    f"4. If writing the 'Preliminary Section', you MUST explicitly populate both the 'List of Tables' and 'List of Figures' sub-headings with bullet points of anticipated tables/figures (e.g., '1. Figure 1: Growth Chart'). DO NOT leave them empty.\n"
                    f"5. For non-scientific topics, deduce logical equivalents for 'Hypothesis' or 'Sampling'.\n"
                    f"6. If writing the 'Reference Section', you MUST explicitly populate the 'Bibliography or Literature Cited' sub-heading with all the URLs listed under 'Sources Available' below. DO NOT leave it empty.\n\n"
                    f"Raw Research:\n{state.raw_research}\n\n"
                    f"Sources Available:\n"
